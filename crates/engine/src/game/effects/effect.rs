...
fn snapshot_transient_modifications(
    ...
    modifications
        ...
        .map(|modification| match modification {
            ...
            //
            // CR 611.3a (@2926) scopes this deliberately: only continuous effects
            ...
            ContinuousModification::AddKeyword {
                ...
                // CR 609.3 (@2851) + follow-up F1: no colour was chosen, because a
            ...
            ContinuousModification::AddKeyword {
                ...
                // Symmetric with the Protection arm above: CR 609.3 (@2851) + F1.
                None => modification.clone(),
            },
